    ...
    <div className={cn('flex gap-2', className)}>
      <div
        ...
        {variant === 'default' && (
          <>
            <div
              className='absolute inset-0 rounded-full border-t-[1.5px] border-b-[1.5px] border-black/30 dark:border-white/30' />
            <motion.div
        ...
        {variant === 'cube' && (
          <motion.div
            className='absolute inset-0 bg-white dark:bg-white shadow-[0_0_4px_rgba(255,255,255,0.6)] dark:shadow-[0_0_4px_rgba(255,255,255,0.6)]'
        ...
        {variant === 'dual-ring' && (
          <>
            <div
              className='absolute inset-0 rounded-full border-[1.5px] border-black/20 dark:border-white/20 shadow-[0_0_4px_rgba(0,0,0,0.3)] dark:shadow-[0_0_4px_rgba(255,255,255,0.3)]' />
            <motion.div
