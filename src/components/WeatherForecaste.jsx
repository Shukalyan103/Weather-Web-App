                ...
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-4'>
                        <button
                            ...
                            className='p-1 border border-gray-500 rounded-full hover:bg-gray-800/50 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 transition-colors'
