            ...
            <div id='dail forecast' className='lg:w-3/5 w-full h-full '>
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-4'>
                        <button aria-label="Previous forecast" onClick={() => swipeRef.current.slidePrev()} className=' p-1 border border-gray-500 rounded-full hover:bg-white/10 transition-colors focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none'><ChevronLeft color='white' /></button>
                        <button aria-label="Next forecast" onClick={() => swipeRef.current.slideNext()} className=' p-1 border border-gray-500 rounded-full hover:bg-white/10 transition-colors focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none'><ChevronRight color='white' /></button>
                    </div>
                </div>
