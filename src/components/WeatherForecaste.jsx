            ...
            <div id='dail forecast' className='lg:w-3/5 w-full h-full '>
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-4'>
                        <button onClick={() => swipeRef.current.slidePrev()} aria-label="Previous forecast" className='p-1 border border-gray-500 rounded-full hover:bg-gray-700/50 focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none transition-colors'><ChevronLeft color='white' /></button>
                        <button onClick={() => swipeRef.current.slideNext()} aria-label="Next forecast" className='p-1 border border-gray-500 rounded-full hover:bg-gray-700/50 focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none transition-colors'><ChevronRight color='white' /></button>
                    </div>
                </div>
